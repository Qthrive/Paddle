...
if __name__ == "__main__":
    ...
    folder_path = r'E:\pingpong_train_data\codes\final_output'
    create_video_from_images(folder_path, output_path=r'E:\pingpong_train_data\video\malong.mp4', fps=30)